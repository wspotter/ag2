...
**TL;DR:**
- **Demo implementation**: Build a real-time voice application using [WebRTC](https://webrtc.org/) and connect it with the [**`RealtimeAgent`**](/docs/reference/agentchat/realtime_agent/realtime_agent). You can find the demo example [here](https://github.com/ag2ai/realtime-agent-over-webrtc/tree/main).
