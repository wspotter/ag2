...
### Built-In Logging
AutoGen's SQLite and File Logger - [Tutorial Notebook](/docs/use-cases/notebooks/notebooks/agentchat_logging)

### Full-Service Partner Integrations
- AutoGen partners with [AgentOps](https://agentops.ai) to provide multi-agent tracking, metrics, and monitoring - [Tutorial Notebook](/docs/use-cases/notebooks/notebooks/agentchat_agentops)
