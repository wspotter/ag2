...
<Tip>
[This](https://github.com/ag2ai/build-with-ag2/tree/main/e-commerce-custom_service) is from AG2's *[Build with AG2](https://github.com/ag2ai/build-with-ag2)* repository, find the source files and more use cases there!
</Tip>
