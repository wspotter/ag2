...
AutoGen Studio is an low-code interface built to help you rapidly prototype AI agents, enhance them with skills, compose them into workflows and interact with them to accomplish tasks. It is built on top of the [AutoGen](https://ag2labs.github.io/autogen) framework, which is a toolkit for building AI agents.

Code for AutoGen Studio is on GitHub at [build-with-autogen](https://github.com/ag2labs/build-with-autogen/tree/main/samples/apps/autogen-studio)
...
2.  **Install from Source**
    ...
    - Clone the AutoGen Studio repository from the [build-with-autogen](https://github.com/ag2labs/build-with-autogen) repository and install its Python dependencies:
...
- AutoGen Studio is in the [build-with-autogen](https://github.com/ag2labs/build-with-autogen) repository.
...
- Submit a pull request in the [build-with-autogen](https://github.com/ag2labs/build-with-autogen) repository with your contribution!
...
AutoGen Studio is Based on the [AutoGen](https://ag2labs.github.io/autogen) project. It was adapted from a research prototype built in October 2023 (original credits: Gagan Bansal, Adam Fourney, Victor Dibia, Piali Choudhury, Saleema Amershi, Ahmed Awadallah, Chi Wang).
