...
1. AG2 ([installation instructions](/docs/installation))
2. vLLM

Note: We recommend using a virtual environment for your stack, see [this article](https://docs.ag2.ai/docs/installation/Installation#create-a-virtual-environment-optional) for guidance.
