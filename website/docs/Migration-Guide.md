...
```
Checkout [Logging documentation](https://autogenhub.github.io/autogen/docs/Use-Cases/enhanced_inference#logging) and [Logging example notebook](https://github.com/ag2labs/ag2/blob/main/notebook/agentchat_logging.ipynb) to learn more.
