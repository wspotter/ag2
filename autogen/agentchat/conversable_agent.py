...
from ..tools.dependency_injection import remove_injected_params_from_signature, string_metadata_to_description_field
...
class ConversableAgent(LLMAgent):
    ...
    def _create_tool_if_needed(
        ...
        if isinstance(func_or_tool, Callable):
            func = string_metadata_to_description_field(func_or_tool)
            func = inject(func)
