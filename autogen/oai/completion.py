        ...
        **config,
        ...
        Args:
            context (Dict, Optional): The context to instantiate the prompt.
                ...
                More examples can be found at [templating](https://ag2labs.github.io/autogen/docs/Use-Cases/enhanced_inference#templating).
        ...
        logger.warning(
            ...
            "Please refer to https://ag2labs.github.io/autogen/docs/Use-Cases/enhanced_inference#api-unification"
        )
        if ERROR:
            raise ERROR
